<template>
  <div class="wrapper">
    ...
    <div class="sorting-panel">
      <v-btn @click="functionSortedList('asc')" icon="mdi-sort-ascending" density="compact" variant="outlined"
        color="green" />
      <v-btn @click="functionSortedList('desc')" icon="mdi-sort-descending" density="compact" variant="outlined"
        color="green" />
      <v-btn @click="functionSortedList('none', options.id)" icon="mdi-sort-variant-off" density="compact"
...
function functionSortedList(order) {
  ...
  if (order === 'asc') {
    cards.value.sort(compareByRating);
  } else if (order === 'desc') {
    cards.value.sort((a, b) => compareByRating(b, a));
  } else if (order === 'none') {
